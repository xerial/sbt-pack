...
## 0.10.0
  - [Important] sbt-pack no longer copy dependencies from aggregated projects. To include project dependencies, you need to explicitely use `dependsOn(project, ...)`  [#67](https://github.com/xerial/sbt-pack/issues/67)
